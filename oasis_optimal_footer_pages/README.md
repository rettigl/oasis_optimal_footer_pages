# oasis_optimal_footer_pages

OPTIMAL Oasis footer pages
...
```sh
git clone https://github.com/rettigl/oasis_optimal_footer_pages.git
cd oasis_optimal_footer_pages
...
| Name | E-mail     |
|------|------------|
| Laurenz Rettig | [rettig@fhi-berlin.mpg.de](mailto:rettig@fhi-berlin.mpg.de)
